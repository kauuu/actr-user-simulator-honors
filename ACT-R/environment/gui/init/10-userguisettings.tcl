...
update
wm withdraw .
if {[winfo screenwidth .] != 1512 || [winfo screenheight .] != 982 || [lindex [wm maxsize .] 0] != 3432 || [lindex [wm maxsize .] 1] != 1052} {
  set size_mismatch 1
} else {
  set size_mismatch 0
}
...
if {$reset_window_sizes != "yes"} {
  set window_config(.control_panel) 235x700+1257+141
  set changed_window_list(.control_panel) 1
  set window_config(.copyright) 400x290+556+346
